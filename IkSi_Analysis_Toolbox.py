...
def plot_overview_timeseries(start, end, aqd2dir, mbs_mean, tempsXrInterp, rbr, maximet, fws_rsmpl, cnr_rsmpl):
    ...
    axx[7].set_title('Current Speed & Direction [Blue=$30^\circ$NE, Red=$210^\circ$SW] (Aquadopp)')
    ...
    h2 = axx[8].pcolormesh(tempsXrInterp.time,tempsXrInterp.depth,tempsXrInterp.values,cmap='viridis',vmin=-1.7,vmax=0)
